<div id='landing' class='w-full h-full pt-48'>
    ...
    <div class='w-3/5 rellax' data-rellax-speed='-1'>
        ...
        <div class='link-row rellax' data-rellax-speed='1'>
            <a href='https://www.github.com/junelsolis' target='_blank' class='item'><i class="fab fa-github"></i></a>
            <a href='mailto:info@junelsolis.com' target='_blank' class='item'><i class="fas fa-at"></i></a>
            <a href='https://wa.me/254790503144' target='_blank' class='item'><i class="fab fa-whatsapp"></i></a>
        </div>
    </div>
